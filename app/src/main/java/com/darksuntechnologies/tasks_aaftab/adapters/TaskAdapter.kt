package com.darksuntechnologies.tasks_aaftab.adapters
...
import com.darksuntechnologies.tasks_aaftab.R
import com.darksuntechnologies.tasks_aaftab.models.Task

class TaskAdapter ( var yourListData: List<Task>, var deleteFunctionFromMain: (Int)->Unit, ): RecyclerView.Adapter<TaskAdapter.TaskViewHolder>()
{
